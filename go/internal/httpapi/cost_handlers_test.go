...
// computeEnergy's integration rules, the GET/PUT infra.cost settings
// endpoints, and the cost/summary + cost/energy-history HTTP handlers.
// (The median/percentile helpers computeEnergy relies on were promoted to
// internal/statutil 2026-09-11 — see that package's own tests.)
...
// median/percentile were promoted to internal/statutil 2026-09-11 (a second
// caller, cmd/forge-compress's overhead percentiles, needed the identical
// logic) — their tests moved with them, to internal/statutil/statutil_test.go.
