#!/bin/bash
# /usr/local/lib/forge/start-a4.sh
# Static launcher for the a4 inference slot (port 8088).
...
# SELinux: chcon -t bin_t /usr/local/lib/forge/start-a4.sh
set -euo pipefail

ARGS_FILE=/etc/sysconfig/forge-a4-args
